...
class FeaturedSnippet:
    ...
    def __init__(self, soup):
        ...
        """
        featured_snippet_title = next(
            (getattr(soup.select_one(selector), 'text', None) for selector in SELECTORS['FEATURED_SNIPPET_TITLE'] if
             soup.select_one(selector)), None)
